...
Source0  : https://files.pythonhosted.org/packages/fd/1d/06475e1cd5264c0b870ea2cc6fdb3e37177c1e565c43f56ff17a10e3937f/networkx-3.4.2.tar.gz
...
%prep
%setup -q -n networkx-3.4.2
cd %{_builddir}/networkx-3.4.2
%patch -P 1 -p1
pushd ..
cp -a networkx-3.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729521074
...
cp %{_builddir}/networkx-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-networkx/a907a3f63e21706318eaab36cf744cf8ec13568a || :
...
/usr/share/package-licenses/pypi-networkx/a907a3f63e21706318eaab36cf744cf8ec13568a
