...
Source0  : https://files.pythonhosted.org/packages/86/36/f9367f30c63a9e10f387783dc18b2e0454dc9debb25151b7a6d592590375/networkx-3.2.tar.gz
...
%prep
%setup -q -n networkx-3.2
cd %{_builddir}/networkx-3.2
%patch -P 1 -p1
pushd ..
cp -a networkx-3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697728026
